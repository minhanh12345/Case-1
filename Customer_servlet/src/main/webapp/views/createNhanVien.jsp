...
<div class="container">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td><input placeholder="nhập birtday" name="birthDayDate"></td>
            ...
            <td><input placeholder="nhập phongban" name="phongban"></td>
        </tr>

        </tbody>
    </table>
        <button type="submit" class="btn btn-success">Create Nhan vien</button>
